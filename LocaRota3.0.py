...
Data.cidades_coord = [cidades[c] for c in Data.cidades_sel]

Data.distancias = np.zeros((Data.qtd_cidades, Data.qtd_cidades))
print("\n Calculando distancias entre as cidades (com Geodesic)...\n")
...
for i in range(Data.qtd_cidades):
    for j in range(i + 1, Data.qtd_cidades):
        ...
        Data.distancias[i][j] = Data.distancias[j][i] = distance
        print(f"   Distancia entre {Data.cidades_sel[i]} e {Data.cidades_sel[j]}: {distance:.2f} km")

print("\n\nCalculando melhor rota com Algoritmo Genetico...\n")
melhor_rota = algoritmo_genetico(cidade_inicial, cidades_destino)
